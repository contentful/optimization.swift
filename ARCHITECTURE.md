...
Public generated Swift Package for the native Contentful Optimization SDK release.

## Main areas

- Sources/ContentfulOptimization contains the released Swift implementation.
- Tests/ContentfulOptimizationTests contains package tests.
- Package.swift defines supported platforms, products, and dependencies.
- The authoritative source lives in contentful/optimization and this repository is updated by its release workflow.
